...
import com.merpyzf.filemanager.utils.DensityUtils;
...
public class FileSelectIndicator extends HorizontalScrollView implements IFileSelectorIndicator, View.OnClickListener {
    ...
    public FileSelectIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FileSelectIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public View createIndicatorView(Label label) {
        ...
        tvParams.leftMargin = DensityUtils.dip2px(mContext, 5);
        ...
        ivParams.height = DensityUtils.dip2px(mContext, 40);
