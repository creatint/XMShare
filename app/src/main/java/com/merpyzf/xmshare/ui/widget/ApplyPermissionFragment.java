...
import com.merpyzf.xmshare.util.TransStatusBottomSheetDialog;
...
public class ApplyPermissionFragment extends BottomSheetDialogFragment implements EasyPermissions.PermissionCallbacks {
     ...
     */
    public void haveAll(FragmentManager fragmentManager, Context context,onApplyPermissionCompleted onApplyPermissionCompleted) {

        this.mOnApplyPermissionCompleted = onApplyPermissionCompleted;
